...
function Markers() {
    ...
    console.log("User"+userLocation?.lng+"-"+userLocation?.lat);
    console.log("Source"+soruceCordinates?.lng+"-"+soruceCordinates?.lat);
    console.log("Destination"+destinationCordinates?.lng+"-"+destinationCordinates?.lat);
